...
{
    public class SkipUseCase(ProgramController programController, IIrrigationLog log)
    {
        ...
        public void Execute()
        {
            ...
            this.log.Write($"Zone skipped manually. Valve #{currentStep.ValveId} closed after {elapsed:mm\\:ss}.");
        }
    }
}
